...
\rlettrine{D}{as} profundezas do abysmo, Senhor, clamo por Vós; ouvi a minha oração, Senhor. ℣. Estejam os vossos ouvidos atentos à oração do vosso servo. ℣. Se guardardes a lembrança dos nossos delitos, Senhor, quem poderá subsistir ante Vós, Senhor? ℣. Pois nas vossas mãos está o perdão: e por causa da vossa lei ousei comparecer ante Vós, Senhor.
}\end{paracol}
