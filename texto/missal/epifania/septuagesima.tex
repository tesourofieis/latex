...
\rlettrine{D}{as} profundezas do abismo clamei por Vós, Senhor: ouvi a minha voz. ℣. Que os vossos ouvidos estejam atentos à voz deste vosso servo. ℣. Se julgais as nossas iniquidades, Senhor, quem poderá subsistir ante Vós? ℣. Mas sois propício; por amor da vossa lei esperei em Vós.
}\end{paracol}
...
\rlettrine{R}{ecebendo} as nossas ofertas e orações, Senhor, dignai-Vos purificar-nos por virtude dos vossos celestiais mistérios e ouvi misericordioso os nossos rogos. Por nosso Senhor Jesus Cristo, vosso Filho, que \emph{\&c.}
}\end{paracol}
