...
\begin{nscenter}
\emph{\textbf{Pois isto é o Cálice do meu Sangue do novo e eterno testamento, mistério da fé, que será derramado por vós e por muitos, para a remissão dos pecados.}}
\end{nscenter}
}\end{paracol}
