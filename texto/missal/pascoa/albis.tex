...
\rlettrine{V}{os} suplicamos, Senhor, nosso Deus, permiti que estes sacrossantos mistérios, que instituístes para alcançarmos a regeneração, sejam nosso remédio salutar no presente e no futuro. Por nosso Senhor \emph{\&c.}
}\end{paracol}