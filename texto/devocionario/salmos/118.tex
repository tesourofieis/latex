...
\rlettrine{B}{em-aventurados} os sem mácula no caminho: * os que andam na lei do Senhor.
}\switchcolumn*\latim{
Beáti, qui scrutántur testimónia ejus: * in toto corde exquírunt eum.
}\switchcolumn\portugues{
Bem-aventurados os que procuram os seus testemunhos: * os que de todo o coração O buscam.
}\switchcolumn*\latim{
...
Oxalá que meus passos, * sejam dirigidos ao cumprimento das vossas leis.
}\switchcolumn*\latim{
...
Guardarei as vossos leis: * não me desampareis jamais.
}\end{paracol}
...
De todo meu coração Vos busquei: * não me deixeis transviar dos vossos mandamentos.
}\switchcolumn*\latim{
In corde meo abscóndi elóquia tua: * ut non peccem tibi.
}\switchcolumn\portugues{
Escondi no meu coração as vossas palavras: * para não pecar contra Vós.
}\switchcolumn*\latim{
Benedíctus es, Dómine: * doce me justificatiónes tuas.
}\switchcolumn\portugues{
Bendito sois, ó Senhor: * ensinai-me as vossas leis.
}\switchcolumn*\latim{
In lábiis meis, * pronuntiávi ómnia judícia oris tui.
}\switchcolumn\portugues{
Com meus lábios, * pronunciei todos os juízos da vossa boca.
}\switchcolumn*\latim{
...
Nas vossas leis meditarei: * não me esquecerei das vossas palavras.
}\end{paracol}
...
Tirai o véu dos meus olhos: * e considerarei as maravilhas da vossa lei.
}\switchcolumn*\latim{
Íncola ego sum in terra: * non abscóndas a me mandáta tua.
}\switchcolumn\portugues{
Sou peregrino na terra: * não escondeis de mim os vossos mandamentos.
}\switchcolumn*\latim{
Concupívit ánima mea desideráre justificatiónes tuas, * in omni témpore.
}\switchcolumn\portugues{
Minha alma desejou ansiosa as vossas leis, * em todo o tempo.
}\switchcolumn*\latim{
...
Livrai-me do escárnio e do desprezo: * pois procurei os vossos mandamentos.
}\switchcolumn*\latim{
Étenim sedérunt príncipes, et advérsum me loquebántur: * servus autem tuus exercebátur in justificatiónibus tuis.
}\switchcolumn\portugues{
Porque os príncipes se sentaram e falavam contra mim: * o vosso servo, todavia, meditava nas vossas leis.
}\switchcolumn*\latim{
Nam et testimónia tua meditátio mea est: * et consílium meum justificatiónes tuæ.
}\switchcolumn\portugues{
Pois os vossos decretos são a minha meditação: * e as vossas leis são o meu conselho.
}\end{paracol}
...
\rlettrine{A}{} minha alma prostrou-se por terra: * dai-me a vida segundo a vossa palavra.
}\switchcolumn*\latim{
Vias meas enuntiávi, et exaudísti me: * doce me justificatiónes tuas.
}\switchcolumn\portugues{
Vos expus os meus caminhos e me atendestes: * ensinai-me as vossas leis.
}\switchcolumn*\latim{
...
Minha alma adormeceu de tédio: * fortificai-me com vossas palavras.
}\switchcolumn*\latim{
...
Escolhi o caminho da verdade: * não me esqueci dos vossos juízos.
}\switchcolumn*\latim{
Adhǽsi testimóniis tuis, Dómine: * noli me confúndere.
}\switchcolumn\portugues{
Ó Senhor, aderi aos vossos testemunhos: * não me queirais confundir.
}\switchcolumn*\latim{
...
\rlettrine{I}{mpõe-me} por lei, ó Senhor, o caminho dos vossos justos decretos: * e buscá-lo-ei sempre.
}\switchcolumn*\latim{
...
Desviai os meus olhos, para que não vejam a vaidade: * no vosso caminho fazei-me viver.
}\switchcolumn*\latim{
...
Eis como suspirei pelos vossos mandamentos: * fazei que viva segundo a vossa justiça.
}\end{paracol}
...
E poderei responder aos que me insultam: * que pus a minha esperança nas vossas palavras.
}\switchcolumn*\latim{
Et ne áuferas de ore meo verbum veritátis usquequáque: * quia in judíciis tuis supersperávi.
}\switchcolumn\portugues{
E não tireis jamais da minha boca a palavra da verdade: * pois muito confiei nas vossas promessas.
}\switchcolumn*\latim{
Et custódiam legem tuam semper: * in sǽculum et in sǽculum sǽculi.
}\switchcolumn\portugues{
E guardarei sempre a vossa lei: * pelos séculos e pelos séculos dos séculos.
}\switchcolumn*\latim{
Et ambulábam in latitúdine: * quia mandáta tua exquisívi.
}\switchcolumn\portugues{
E caminharei ao largo: * pois procurei os vossos mandamentos.
}\switchcolumn*\latim{
Et loquébar in testimóniis tuis in conspéctu regum: * et non confundébar.
}\switchcolumn\portugues{
E falarei dos vossos preceitos diante dos reis: * e não me envergonharei.
}\switchcolumn*\latim{
Et meditábar in mandátis tuis, * quæ diléxi.
}\switchcolumn\portugues{
E meditarei nos vossos mandamentos, * que amo.
}\switchcolumn*\latim{
Et levávi manus meas ad mandáta tua, quæ diléxi: * et exercébar in justificatiónibus tuis.
}\switchcolumn\portugues{
Levantarei as minhas mãos para os vossos mandamentos, que amo: * e exercitar-me-ei nas vossas leis.
}\end{paracol}
...
Isto me consolou no meu abatimento: * pois a vossa palavra me deu vida.
}\switchcolumn*\latim{
Supérbi iníque agébant usquequáque: * a lege autem tua non declinávi.
}\switchcolumn\portugues{
Os soberbos procediam sem cessar iniquamente: * mas eu não me afastei da vossa lei.
}\switchcolumn*\latim{
Memor fui judiciórum tuórum a sǽculo, Dómine: * et consolátus sum.
}\switchcolumn\portugues{
Lembrei-me, ó Senhor, dos juízos que exercestes em todos os séculos: * e consolei-me.
}\switchcolumn*\latim{
...
Vossas leis eram dignas de ser cantadas por mim, * no lugar da minha peregrinação.
}\switchcolumn*\latim{
...
Considerei os meus caminhos: * e voltei os meus passos para os vossos testemunhos.
}\switchcolumn*\latim{
...
As redes dos pecadores me cingiram: * mas não me esqueci da vossa lei.
}\switchcolumn*\latim{
Média nocte surgébam ad confiténdum tibi, * super judícia justificatiónis tuæ.
}\switchcolumn\portugues{
À meia noite levantava-me para Vos louvar, * por vossos juízos cheios de justiça.
}\switchcolumn*\latim{
...
A terra está cheia, ó Senhor, da vossa misericórdia: * ensinai-me os vossos preceitos.
}\end{paracol}
...
Antes de ser humilhado, pequei: * mas agora obedeço à vossa palavra.
}\switchcolumn*\latim{
Bonus es tu: * et in bonitáte tua doce me justificatiónes tuas.
}\switchcolumn\portugues{
Vós sois bom: * e, por vossa bondade, ensinai-me os vossos decretos.
}\switchcolumn*\latim{
Multiplicáta est super me iníquitas superbórum: * ego autem in toto corde meo scrutábor mandáta tua.
}\switchcolumn\portugues{
A iniquidade dos soberbos multiplicou-se contra mim: * porém eu, guardarei de todo meu coração os vossos mandamentos.
}\switchcolumn*\latim{
...
Para mim foi bom que me humilhásseis: * para aprender os vossos decretos.
}\switchcolumn*\latim{
Bonum mihi lex oris tui, * super míllia auri et argénti.
}\switchcolumn\portugues{
A lei da vossa boca é boa para mim, * melhor que milhões de oiro e prata.
}\end{paracol}
...
\rlettrine{A}{s} vossas mãos fizeram-me e formaram-me: * dai-me inteligência e aprenderei os vossos mandamentos.
}\switchcolumn*\latim{
Qui timent te vidébunt me, et lætabúntur: * quia in verba tua supersperávi.
}\switchcolumn\portugues{
Os que Vos temem ver-me-ão e alegrar-se-ão: * pois pus toda minha esperança nas vossas palavras.
}\switchcolumn*\latim{
...
Sejam confundidos os soberbos, pois injustamente maquinaram males contra mim: * eu, porém, ponderarei os vossos mandamentos.
}\switchcolumn*\latim{
...
Seja imaculado o meu coração na prática dos vossos mandamentos, * para que não seja confundido.
}\end{paracol}
...
\rlettrine{A}{} minha alma desfaleceu à espera da vossa salvação: * mas tenho confiado na vossa palavra.
}\switchcolumn*\latim{
...
Pois tornei-me como um odre exposto à geada: * mas não me esqueci dos vossos decretos.
}\switchcolumn*\latim{
...
Vivificai-me segundo a vossa misericórdia: * e guardarei os mandamentos saídos da vossa boca.
}\end{paracol}
...
Por vossa ordem continua dos dias: * porque todas as coisas Vos servem.
}\switchcolumn*\latim{
...
Jamais me esquecerei dos vossos preceitos: * pois neles me destes a vida.
}\switchcolumn*\latim{
Tuus sum ego, salvum me fac: * quóniam justificatiónes tuas exquisívi.
}\switchcolumn\portugues{
Eu sou vosso, salvai-me: * porque procurei as vossas leis.
}\switchcolumn*\latim{
...
Compreendi mais que todos meus mestres: * pois os vossos mandamentos são a minha meditação.
}\switchcolumn*\latim{
...
Retirei os meus pés de todo o mau caminho: * para guardar as vossas palavras.
}\switchcolumn*\latim{
...
Tenho sido imensamente humilhado, ó Senhor: * fazei-me viver segundo a vossa palavra.
}\switchcolumn*\latim{
...
Minha alma está sempre nas minhas mãos: * porém, não me esqueci da vossa lei.
}\switchcolumn*\latim{
Posuérunt peccatóres láqueum mihi: * et de mandátis tuis non errávi.
}\switchcolumn\portugues{
Os pecadores armaram-me laços: * porém, não me apartei dos vossos mandamentos.
}\switchcolumn*\latim{
Hereditáte acquisívi testimónia tua in ætérnum: * quia exsultátio cordis mei sunt.
}\switchcolumn\portugues{
Adquiri os vossos ensinamentos para que sejam eternamente o meu património: * pois são a alegria do meu coração.
}\switchcolumn*\latim{
Inclinávi cor meum ad faciéndas justificatiónes tuas in ætérnum, * propter retributiónem.
}\switchcolumn\portugues{
Inclinei o meu coração a praticar sempre as vossas leis, * pela retribuição.
}\end{paracol}
...
Ajudai-me e serei salvo: * e meditarei sempre nas vossas leis.
}\switchcolumn*\latim{
Sprevísti omnes discedéntes a judíciis tuis: * quia injústa cogitátio eórum.
}\switchcolumn\portugues{
Desprezastes todos os que se desviam das vossas leis: * pois é injusto o seu pensamento.
}\switchcolumn*\latim{
...
\rlettrine{T}{enho} feito juízo e a justiça: * não me entregues aos que me caluniam.
}\switchcolumn*\latim{
Súscipe servum tuum in bonum: * non calumniéntur me supérbi.
}\switchcolumn\portugues{
Ampara o vosso servo para o bem: * não me caluniem os soberbos.
}\switchcolumn*\latim{
...
Trata o vosso servo segundo a vossa misericórdia: * e ensinai-me os vossos justos decretos.
}\switchcolumn*\latim{
...
Por isso amei os vossos mandamentos, * mais do que o oiro e o topázio.
}\switchcolumn*\latim{
...
A explicação das vossas palavras alumia: * e dá inteligência aos pequeninos.
}\switchcolumn*\latim{
...
Olhai para mim e compadecei-Vos de mim, * segundo o juízo que usas com os que amam o vosso nome.
}\switchcolumn*\latim{
...
Fazei que a luz do vosso rosto reluza sobre o vosso servo: * e ensinai-me os vossos decretos.
}\switchcolumn*\latim{
Éxitus aquárum deduxérunt óculi mei: * quia non custodiérunt legem tuam.
}\switchcolumn\portugues{
Rios de lágrimas derramaram os meus olhos: * por não terem guardado a vossa lei.
}\end{paracol}
...
Vossa palavra é refinadíssima: * e o vosso servo a tem amado.
}\switchcolumn*\latim{
Adolescéntulus sum ego et contémptus: * justificatiónes tuas non sum oblítus.
}\switchcolumn\portugues{
Eu sou pequeno e desprezível: * mas não esqueci os vossos decretos.
}\switchcolumn*\latim{
...
A tribulação e a angústia surpreenderam-me: * os vossos mandamentos são a minha meditação.
}\switchcolumn*\latim{
Æquitas testimónia tua in ætérnum: * intelléctum da mihi, et vivam.
}\switchcolumn\portugues{
Vossos preceitos são cheios duma eterna equidade: * dai-me a inteligência deles e viverei.
}\end{paracol}
...
\rlettrine{C}{lamei} de todo meu coração, ouvi-me, ó Senhor: * buscarei os vossos decretos.
}\switchcolumn*\latim{
Clamávi ad te, salvum me fac: * ut custódiam mandáta tua.
}\switchcolumn\portugues{
Clamei a Vós, salvai-me: * para que guarde os vossos mandamentos.
}\switchcolumn*\latim{
...
Meus olhos anteciparam-se para Vós antes da aurora: * para meditar as vossas palavras.
}\switchcolumn*\latim{
...
Desde o princípio soube acerca dos vossos testemunhos: * que estabelecestes para sempre.
}\end{paracol}
...
A salvação está longe dos pecadores: * pois não buscam os vossos justos decretos.
}\switchcolumn*\latim{
Misericórdiæ tuæ multæ, Dómine: * secúndum judícium tuum vivífica me.
}\switchcolumn\portugues{
Muitas são, ó Senhor, as vossas misericórdias: * dai-me a vida segundo o vosso juízo.
}\switchcolumn*\latim{
Multi qui persequúntur me, et tríbulant me: * a testimóniis tuis non declinávi.
}\switchcolumn\portugues{
Muitos são os que me perseguem e me atribulam: * porém, não me desviei dos vossos mandamentos.
}\switchcolumn*\latim{
Vidi prævaricántes, et tabescébam: * quia elóquia tua non custodiérunt.
}\switchcolumn\portugues{
Vi os prevaricadores e consumia-me: * pois eles não guardaram as vossas palavras.
}\switchcolumn*\latim{
Vide quóniam mandáta tua diléxi, Dómine: * in misericórdia tua vivífica me.
}\switchcolumn\portugues{
Vede, ó Senhor, quanto tenho amado os vossos mandamentos: * dai-me a vida pela vossa misericórdia.
}\switchcolumn*\latim{
...
Possuem muita paz os que amam a vossa lei: * e não há para eles nenhuma ocasião de queda.
}\switchcolumn*\latim{
...
\rlettrine{C}{hegue,} ó Senhor, a minha súplica à vossa presença: * dai-me entendimento segundo a vossa palavra.
}\switchcolumn*\latim{
...
Dos meus lábios sairá um hino, * quando me ensinardes os vossos decretos.
}\switchcolumn*\latim{
...
Tenho desejado, ó Senhor, a vossa salvação: * e a vossa lei é a minha meditação.
}\switchcolumn*\latim{
...
Andei errante, como ovelha, que se extraviou: * buscai o vosso servo, pois me não esqueci dos vossos mandamentos.
}\end{paracol}
