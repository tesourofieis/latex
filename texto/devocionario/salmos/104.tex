...
Buscai o Senhor e fortificai-vos n’Ele: * buscai sempre a sua face.
}\switchcolumn*\latim{
...
Ó descendentes de Abraão, seus servos: * ó filhos de Jacob, seus escolhidos.
}\switchcolumn*\latim{
...
Ele lembrou-se para sempre da sua aliança: * e da palavra que pronunciou para mil gerações:
}\switchcolumn*\latim{
Quod dispósuit ad Ábraham: * et juraménti sui ad Isaac:
}\switchcolumn\portugues{
Da que a Abraão fez: * e do juramento que fez a Isaac:
}\switchcolumn*\latim{
Et státuit illud Jacob in præcéptum: * et Israël in testaméntum ætérnum:
}\switchcolumn\portugues{
O juramento que confirmou a Jacob como uma lei: * e a Israel para uma eterna aliança:
}\switchcolumn*\latim{
Dicens: tibi dabo terram Chánaan, * funículum hereditátis vestræ.
}\switchcolumn\portugues{
Dizendo: dar-te-ei a terra de Canaan, * como porção de tua herança.
}\switchcolumn*\latim{
Cum essent número brevi, * paucíssimi et íncolæ ejus:
}\switchcolumn\portugues{
Sendo eles em pequeno número, * pouquíssimos e estrangeiros naquela terra:
}\switchcolumn*\latim{
...
Não permitiu que alguém os ofendesse: * e castigou reis por causa deles.
}\switchcolumn*\latim{
...
A fim de que instruísse os seus príncipes como a si mesmo: * e ensinasse a prudência aos seus anciãos.
}\switchcolumn*\latim{
...
Aumentou extraordinariamente o seu povo: * e tornou-o forte sobre os seus inimigos.
}\switchcolumn*\latim{
Convértit cor eórum ut odírent pópulum ejus: * et dolum fácerent in servos ejus.
}\switchcolumn\portugues{
Mudou-lhes o coração para que odiassem o seu povo: * e usassem de dolos com seus servos.
}\switchcolumn*\latim{
...
Enviou trevas e escureceu: * e se não exacerbaram com suas palavras.
}\switchcolumn*\latim{
...
Falou e vieram moscas de todas as castas: * e mosquitos por todo o território.
}\switchcolumn*\latim{
...
Falou e vieram gafanhotos e lagartos * em tanta abundância que não tinham número:
}\switchcolumn*\latim{
...
Os conduziu com prata e com oiro: * e não havia enfermo nas suas tribos.
}\switchcolumn*\latim{
Lætáta est Ægýptus in profectióne eórum: * quia incúbuit timor eórum super eos.
}\switchcolumn\portugues{
Alegrou-se o Egipto com a partida deles: * por causa do grande temor que lhe causavam.
}\switchcolumn*\latim{
