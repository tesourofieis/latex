...
\rlettrine{M}{uitas} vezes me combateram desde a minha mocidade, * diga-o agora Israel.
}\switchcolumn*\latim{
...
Sobre o meu dorso trabalharam os pecadores: * prolongaram a sua iniquidade.
}\switchcolumn*\latim{
...
Os que passavam não disseram: a bênção do Senhor seja sobre vós: * nós vos abençoamos em nome do Senhor.
}\end{paracol}
